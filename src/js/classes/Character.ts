...
import { CharacterData, CharacterInterface } from '@/types/index';
...
export class Character implements CharacterInterface {
  ...
  public nameLabel: THREE.Mesh | null = null;
  
  private scene: THREE.Scene;
  private camera: THREE.Camera;

  constructor(data: CharacterData, scene: THREE.Scene, camera: THREE.Camera) {
    this.name = data.name;
